...
void Skybox::setUpFaces(bool left) {
	...
	this->faces.push_back(".\\skybox\\px.ppm");
	this->faces.push_back(".\\skybox\\nx.ppm");
	this->faces.push_back(".\\skybox\\py.ppm");
	this->faces.push_back(".\\skybox\\ny.ppm");
	this->faces.push_back(".\\skybox\\pz.ppm");
	this->faces.push_back(".\\skybox\\nz.ppm");
